...
# Вводятся числа, пока не введут 0. Определите кол-во чётных чисел из введённой последовательности
...
# minn = int(input('Введите вес арбузов: '))
# maxx = 0
# for _ in range(n - 1):
#     weight = int(input('Введите вес арбузов: '))
#     if weight > maxx:
#         maxx = weight
#     if weight < minn:
#         minn = weight
